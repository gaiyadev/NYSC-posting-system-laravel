...
<div class="row">
    ...
    <div class="col-md-12">
      @include('include/message')
        <form id="msform" action="{{route('senate.add')}}" method="POST" autocomplete="on" > 
         @csrf      
            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title text-success">Add to Senate List</h2><br/>
                ...
                <input type="date" value=" {{old('dob')}} " name="dob" min="1000-01-01" max="2005-09-09" required="required" />
                ...
                <input type="date" value=" {{old('year')}} " name="year" min="1000-01-01" max="2019-12-27" required="required" />

               
                <input  id="box"  type="submit"  name="submit" class="submit action-button" value="ADD"/>
            </fieldset>
