...
<div class="row">
    ...
    <div class="col-md-12">
      @include('include/message')
        <form id="msform" action=" {{ route('saveSenate',  $SenateLists->id)}} " method="POST" autocomplete="on" > 
         @csrf      
            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title text-success">Update Senate List</h2><br/>
                <!-- <h3 class="fs-subtitle">Tell us something more about you</h3><br/> -->
                <input type="text"  value="{{ $SenateLists->fname }}" name="fname" placeholder="First Name" required="required" />
                <input type="text" value="{{ $SenateLists->lname }}" name="lname" placeholder="Last Name" required="required" />
                <input type="text" value="{{$SenateLists->mname}}"  name="mname" placeholder="Middle Name" />
                
              
                   <p class="text-success" style="margin-left: 0px; font-size: 12px;">Date Of Birth</p>

                <input type="date" value=" {{ $SenateLists->dob }} " name="dob" min="1000-01-01" max="2005-09-09" required="required" />
                ...
                <input type="text" value=" {{ $SenateLists->school}} " name="school" placeholder="School Graduated" required="required" />
                 ...
                 <input type="text" value=" {{ $SenateLists->course}} "  name="course" placeholder="Course of study" required="required" />
                   <input type="text" value="{{ old('matric') }}" name="matric" placeholder="Matric Number" required="required" />
                ...
                <input type="date" value=" {{$SenateLists->year}} " name="year" min="1000-01-01" max="2019-12-27" required="required" />

               
                <input  id="box"  type="submit"  name="submit" class="submit action-button" value="UPDATE"/>
            </fieldset>
